...
git commit -m "" --> message needed for in general update git push --> to remote repository
...
--> .pub for public github interface cat testkey.pub 
--> print out key for push --> paste into github pbcopy <.../WikiKey.pub>ß
